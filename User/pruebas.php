...
<div class="row g-12">
  <div class="col-md-12">
   ...
   <!-- <p>Ready to beyond the starter template? Check out these open source projects that you can quickly duplicate to a new GitHub repository.</p> --->
    ...
    <h3> <small class="text-muted"><?php echo $row2['Nombre_menor'] ?> <?php echo $row2['apellidoPater_menor'] ?> <?php echo $row2['apellidoMaterno_Menor'] ?></small></h3>
      ...
      <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                       ...
                       <?php
                          if ( $row3['id_usuario'] =="" ){
                            ...
                            ?>
                                 <?php   include ('ajaxTallaPeso/detallesGraficas.php'); ?>
