...
<main>
  ...
  if ( $row2['id_usuario'] =="" ){
                            ...
                            Datos de Personales. Aun vacios <a href="misDatos.php" class="alert-link">Datos Personales</a>. Da click para llenar.</div>
...
<script src="dist/js/bootstrap.min.js"></script> 
                           <?php
                            ...
                            include ('./ajaxTallaPeso/sugerencias_ajax.php'); 
