...
?>
 ...
 include 'conexion-tabla.php';
  ...
  $row3=$resultado3->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        $consulta4 = "SELECT * FROM userlocal WHERE usuario='$usuario'";
  ...
  <div class="container my-5">
    <?php
                          ...
                          if ( $row4['usuario'] =="" ){
                            ...
                            <div class="alert alert-primary" role="alert">
                            Datos de Cuenta. Aun vacios <a href="miCuenta.php" class="alert-link">Mis Datos</a>. Da click para llenar.</div>
                            <?php
                          }
