...
<main id="perfilform" >
  ...
  <input type="date" class="form-control"  id="fecha_Nacimiento"  value=""  placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">
  ...
  <input type="text" class="form-control"   id="edads"  value=""  placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">
          ...
          <input type="hidden" id="obs" value="<?php echo $_SESSION['user_email_address']?>"> 
