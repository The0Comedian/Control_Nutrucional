...
<main id="perfilform" >
  ...
  <input type="text" class="form-control"  id="apellido_Paterno"  value=""  placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">

  <span class="input-group-text" id="addon-wrapping">Apellido Materno</span>
  <input type="text" class="form-control"  id="apellido_Materno"  value=""  placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">
  ...
  <a routerLink="/" class="navbar-brand">  <?php  echo $row2['usuario']?></a> 
   <input type="hidden" id="obs" value="<?php echo $row['email'], $row2['usuario']  ?>"> 
   <input type="hidden" id="nombre" value="<?php echo $row['email'], $row2['usuario']  ?>"> 
